...
addButton :: proc(ctx: ^Context, parent: ^UIElement, text: string, zIndex: i32, style: UIStyle, offset: Vec2) -> ^UIElement {
    ...
    button.pos = Vec2{viewport.viewportContext.startX + offset.x, viewport.viewportContext.startY + offset.y}
    button.rect = Rect{
        button.pos,
        Vec2{text_w + padding_x*2, text_h + padding_y*2},
    }
...
addText :: proc(ctx: ^Context, parent: ^UIElement, text: string, zIndex: i32, style: UIStyle) -> ^UIElement {
